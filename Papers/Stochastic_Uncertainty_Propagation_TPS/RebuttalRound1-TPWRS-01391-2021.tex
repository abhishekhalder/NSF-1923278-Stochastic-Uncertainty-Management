...
{\nib{ \blue Please note that the convergence guarantee given by equation (14) in the revised manuscript is pointwise in time, i.e., for each $k\in\mathbb{N}$. Unlike traditional numerical methods, there is no concept of {\red{TBD.}}}}
