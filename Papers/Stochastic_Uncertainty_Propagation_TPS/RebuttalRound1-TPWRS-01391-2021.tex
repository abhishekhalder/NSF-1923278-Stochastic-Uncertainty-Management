...
{\nib \blue{In the previous version, the strict 10 page limit enforced small figure sizes. In the revised manuscript, Figures 5 and 6 are made larger. Also, the Fig. 6 in the revised manuscript shows the transient $(\theta_i,\omega_i)$ bivariate marginals for \ul{all the five generators in Case II}; the previous version showed the same only for the generator 4 (bus 6).}}
