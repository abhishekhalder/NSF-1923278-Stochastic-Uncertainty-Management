...
{\nib{ \blue While the depiction of the computational times in Figs. 8 and 9 in the revised manuscript are somewhat unconventional, we explain why we choose to plot that way. \ul{To aid clarity, in the revised manuscript, we have added an excerpt of the following at the end of Sec. V-A.}
