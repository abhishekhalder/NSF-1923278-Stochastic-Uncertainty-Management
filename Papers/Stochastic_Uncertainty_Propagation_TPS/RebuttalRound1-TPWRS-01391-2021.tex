...
Please note that in Sec. V, we have used MATPOWER and the Python-library ANDES (refs. [59] and [60]) for obtaining some parameters, as explained in the first paragraph of V-A. }}
