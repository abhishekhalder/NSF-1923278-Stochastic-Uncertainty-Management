...
{\nib \blue{In Sec. V-A, we corrected ``assuming" $\rightarrow$ ``are assumed". We corrected the two typos pointed out in comment \textbf{R4.8} in this rebuttal document. We also corrected minor mathematical typos in (19), (20a), (22a).}}
