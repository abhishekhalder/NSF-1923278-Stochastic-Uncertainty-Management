...
{\nib \blue{In Sec. V-A, we corrected ``assuming" $\rightarrow$ ``are assumed". We corrected the two typos pointed out in comment \textbf{R4.8} in this rebuttal document.}}
