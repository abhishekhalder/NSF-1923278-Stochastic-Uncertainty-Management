...
{\nib{ \blue Our responses to the three numbered sub-comments below.

(1) The second order sample path dynamics model we used is standard in power systems literature, and specifically as we pointed}}
