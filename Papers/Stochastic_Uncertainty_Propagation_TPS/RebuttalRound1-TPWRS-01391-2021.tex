...
{\nib \blue{We appreciate the comment. As per the reviewer's suggestion, in the revised manuscript, we have included a sentence (marked blue) in Sec. I.1, second paragraph (last sentence) mentioning the usage of SDAEs in power system dynamic simulation. That sentence in the revised manuscript contains two newly added references: [22] and [23], both on simulating SDAE sample paths.}}
