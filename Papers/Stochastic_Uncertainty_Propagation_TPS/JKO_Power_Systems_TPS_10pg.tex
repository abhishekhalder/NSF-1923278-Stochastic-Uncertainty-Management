...
Fig. \ref{fig:CompTimeIEEE14bus} shows the computational times for updating $\{\bm{x}_{k}^{i},\varrho_{k}^{i}\}_{i=1}^{N}$ via the algorithm in Sec. \ref{sec:ProxAlgo} for \textbf{Cases I} and \textbf{II}.  
