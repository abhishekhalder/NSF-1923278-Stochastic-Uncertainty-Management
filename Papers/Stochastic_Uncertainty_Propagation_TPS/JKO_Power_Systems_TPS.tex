...
We consider a power network with $n=20$ generators, and propagate the transient joint state PDFs supported over $\mathbb{T}^{20}\times\mathbb{R}^{20}$. We take the initial joint state PDF as
\begin{align*}
\rho_{0}(t=0,\theta(0),\omega(0)) = &\;{\rm{Unif}}\left([0,2\pi)^{n}\;\text{rad}\right)\\
