...
\end{align}
\end{subequations}
where $P_{i}^{\text{mech}}$ is the mechanical power input, and $|V_{i}|$ is the voltage magnitude for generator $i$. {\red{{\textbf{Xinbo:}} One sentence saying any approximation made in (2) by using $V_{i}$ instead of the internal voltage $E_{i}$}}
