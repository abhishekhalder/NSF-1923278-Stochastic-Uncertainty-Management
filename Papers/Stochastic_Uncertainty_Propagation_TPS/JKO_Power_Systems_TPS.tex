...
\end{align}
which is the sum of a potential energy (expected value of $U$), a kinetic energy (expected value of $F$), and an internal energy (scaled negative entropy $-\int\tilde{\rho}\log\tilde{\rho}$). Indeed, the functional \eqref{LyapButNotProx} is a Lyapunov functional along the solution of \eqref{NewPDE}. To see this, ...
