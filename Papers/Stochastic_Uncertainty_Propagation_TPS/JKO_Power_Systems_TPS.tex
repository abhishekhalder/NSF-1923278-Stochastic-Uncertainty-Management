...
To numerically compute \eqref{KineticProx}, we employ the probability-weighted scattered point cloud-based proximal algorithm proposed in \cite{caluya2019TAC}.
