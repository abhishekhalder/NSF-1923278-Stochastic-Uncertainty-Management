...
\begin{align}
\tilde{\varrho}_{k} = {\text{prox}}^{{\rm{dist}}}_{h\widetilde{\Phi}}(\tilde{\varrho}_{k-1}), \quad k\in\mathbb{N}, \quad \varrho_{0}(\bm{x}) := \rho_{0}(\bm{x})
\label{KineticProx}	
\end{align}


was established in \cite{duong2014conservative}.
