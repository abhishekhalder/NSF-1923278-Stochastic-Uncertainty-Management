...
With $N=1000$ random samples from the initial joint PDF \eqref{rho0synthetic}, we use the Euler-Maruyama scheme together with the Algorithm \ref{algo:KineticProx} for propagating $\{\bm{x}_{k}^{i},\varrho_{k}^{i}\}_{i=1}^{N}$. We used  
