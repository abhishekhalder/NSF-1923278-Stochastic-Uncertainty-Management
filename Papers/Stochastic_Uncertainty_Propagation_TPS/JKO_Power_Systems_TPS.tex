...
We consider a power network with $n=20$ generators, and propagate the transient joint state PDFs supported over $\mathbb{T}^{20}\times\mathbb{R}^{20}$. We take the initial joint state PDF at $t=0$ as
\begin{align}
