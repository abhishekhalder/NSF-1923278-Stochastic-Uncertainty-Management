...
\caption{\small{Time evolution of the $(\theta_{i},\omega_{i})$ bivariate marginal PDFs, where $i=1,\hdots,5$, for the Kron-reduced IEEE 14 bus simulation setup described in Sec. \ref{subsec:NumSimIEEEBus}. The $5$ rows above corresponds to the $5$ generator nodes; the columns correspond to the time snapshots.}}
\vspace*{-0.1in}
