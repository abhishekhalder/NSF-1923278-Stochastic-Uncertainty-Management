...
Thus, $\tilde{\varrho}_{k}^{i}$ is the joint PDF value obtained from \eqref{KineticProx} at $\tilde{\bm{x}}_{k}^{i}$, the $i$th state sample at the $k$th time step. The schematic of the algorithm is shown in Fig. \ref{fig:BlockDiagm}. 
