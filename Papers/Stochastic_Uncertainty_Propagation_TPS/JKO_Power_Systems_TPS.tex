...
\author{Abhishek~Halder,~\IEEEmembership{Senior Member,~IEEE,} 
        Kenneth~F. Caluya,
        Pegah~Ojaghi,
        and~Xinbo~Geng% <-this % stops a space
\thanks{A. Halder and K.F. Caluya are with the Department of Applied Mathematics, University of California, Santa Cruz, CA 95064, USA, {\texttt{\{ahalder,kcaluya\}@ucsc.edu}}.}% <-this % stops a space
...
The corresponding macroscopic dynamics governing the flow of the joint state PDF $\rho(t,\bm{\theta},\bm{\omega})$ is given by a kinetic Fokker-Planck \cite{villani2006hypocoercive} partial differential equation (PDE)
\begin{align}
