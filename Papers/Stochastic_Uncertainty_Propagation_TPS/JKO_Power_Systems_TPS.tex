...
Finally, we transform the proximal updates back to the $\left(\bm{\theta},\bm{\omega}\right)^{\top}$ state space via the pushforward $\bm{\Psi}^{-1}$ as
\begin{align}
...
With $N=1000$ random samples from the initial joint PDF \eqref{rho0synthetic}, we use Algorithm \ref{algo:KineticProx} to 
