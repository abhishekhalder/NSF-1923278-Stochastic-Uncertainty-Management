...
For completeness, the proximal algorithm for updating $\{\tilde{\varrho}_{k-1}^{i}\}_{i=1}^{N}\mapsto\{\tilde{\varrho}_{k}^{i}\}_{i=1}^{N}$ is outlined in Algorithm \ref{algo:KineticProx}. As shown in Fig. \ref{fig:BlockDiagm}, this algorithm takes the pre and post update state samples 
...
and $\{\tilde{\varrho}_{k-1}^{i}\}_{i=1}^{N}$ as inputs. The Algorithm \ref{algo:KineticProx} has additional 
