...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{CompTimeSyntheticPowerSystem.png}
\caption{\small{The computational time for propagating the transient joint PDFs over $\mathbb{T}^{20}\times\mathbb{R}^{20}$ for the simulation set up in Sec. \ref{subsec:NumSimSynthetic}.}}
