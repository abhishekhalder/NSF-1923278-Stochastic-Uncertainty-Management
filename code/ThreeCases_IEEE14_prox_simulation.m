...
for j=1:numSteps
   ...
   toc_IEEE14bus_case0_norminal(r) = toc;
end
total_comptime_IEEE14bus_case0_norminal = sum(comptime,2);
...
textfilename = 'total_comptime_IEEE14bus_case0_nominal.txt';
dlmwrite(textfilename, 6*total_comptime_IEEE14bus_case0_norminal,'delimiter','\t','precision','%.64f');