...
C_1 = (1/cc)*pdist2(eta-(h*GradU),etaprime,'squaredeuclidean');

C_2 =(1/cc)*12*pdist2( -eta/2 - xi/h,-(-etaprime/2 + xiprime/h ),'squaredeuclidean');
...
while k<maxiter  
    ...
    z(:,k+1) = (Xi./(G'*y(:,k))).^(1/(((cc*beta*epsilon)/(h))+1));
